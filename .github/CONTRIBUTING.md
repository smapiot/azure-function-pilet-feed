...
Please find more information about how to setup your machine for developing in [the source documentation](../README.md).

### Reporting Bugs

Before creating bug report, please make sure that you first check the [existing issues](https://github.com/smapiot/azure-function-pilet-feed/issues?q=is%3Aopen+is%3Aissue+label%3Abug), as you might find that the issue is already reported. Fill out [the required template](https://github.com/smapiot/azure-function-pilet-feed/issues/new?template=bug_report.md), the information it asks for helps us resolve issues faster.
...
Before creating enhancement suggestions, please make sure that you first check the [existing suggestions](https://github.com/smapiot/azure-function-pilet-feed/issues?q=is%3Aopen+is%3Aissue+label%3Aenhancement), as you might find that the enhancement has already been requested. Fill out [the template](https://github.com/smapiot/azure-function-pilet-feed/issues/new?template=feature_request.md), including the steps that you imagine you would take if the feature you're requesting existed.
...
- **Include screenshots and animated GIFs** which help you demonstrate the steps or point out the part of `azure-function-pilet-feed` which the suggestion is related to. *Note*: We usually live in code. Any code you can already show would be the best illustration.
...
1. Firstly you need a local fork of the the project, so go ahead and press the `fork` button in
   ...
   note that it's been forked underneath the project name: `Forked from smapiot/azure-function-pilet-feed`.
   ...
   ```sh
   git remote add upstream git@github.com:smapiot/azure-function-pilet-feed.git
   ```
...
3. Do some work :) This is the fun part where you get to contribute to `azure-function-pilet-feed` :rocket:.
...
6. After the code is successfully pushed to the origin repository, navigate to
   the [repository](https://github.com/smapiot/azure-function-pilet-feed/pulls) and
   issue a new pull request.
